...
public class ConvertCode {
    ...
    public static void main(String args[]) {
        String productNo = "30303032313233343536373839414243";
        System.out.println(productNo);
        String a = "000100001000";
        System.out.println(convertStringToHex(a));
        String hello = "Hello Client";
        System.out.println(hexString2Bytes(convertStringToHex(hello)));
