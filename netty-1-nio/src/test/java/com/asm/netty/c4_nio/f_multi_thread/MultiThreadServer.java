 ...
 *
 * 多线程 的selector应用
 *  分工操作 （boss 和 worker 都有自己独立的线程和 selector）
 *      Boss   : 负责接待 连接操作
 *      worker : 负责读写，每个work负责 一或多个SockerChannel读写事件
 *
 * 难点：解决 boss (register ) 和 worker线程里 ( select() )前后顺序 问题
 *      register 先执行 还可以， select 先执行的话 将阻塞住
 *
 * 核心：模仿 netty的 操作步骤
 */
...
System.out.println("<<<<<<<<<<<<<<< while    end <<<<<<<<<<<<<<<");
        ...
        /*
>>>>>>>>>>>>>>> while beging >>>>>>>>>>>>>>>
20:22:38 [DEBUG] [boss] c.a.n.c.f.MultiThreadServer - connected... /127.0.0.1:5465
20:22:38 [DEBUG] [boss] c.a.n.c.f.MultiThreadServer - before register... /127.0.0.1:5465
20:22:38 [DEBUG] [worker-0] c.a.n.c.f.MultiThreadServer - worker-select()阻塞中...
20:22:38 [DEBUG] [boss] c.a.n.c.f.MultiThreadServer - after  register... /127.0.0.1:5465
<<<<<<<<<<<<<<< while    end <<<<<<<<<<<<<<<
20:22:38 [DEBUG] [worker-0] c.a.n.c.f.MultiThreadServer - >>>>>>> worker beging ......
20:22:38 [DEBUG] [worker-0] c.a.n.c.f.MultiThreadServer - <<<<<<< worker   end ......
20:22:38 [DEBUG] [worker-0] c.a.n.c.f.MultiThreadServer - worker-select()阻塞中...
20:22:38 [DEBUG] [worker-0] c.a.n.c.f.MultiThreadServer - >>>>>>> worker beging ......
20:22:38 [DEBUG] [worker-0] c.a.n.c.f.MultiThreadServer - read...... /127.0.0.1:5465
+--------+-------------------- all ------------------------+----------------+
position: [0], limit: [16]
         +-------------------------------------------------+
