...
//    {
        ...
        new ServerBootstrap()
                /**
                 * 2. 添加 NioEventLoopGroup 组件 ( 相当于加 BossEventLoop 和 WorkerEventLoop  )
                 *
                 *  NioEventLoopGroup 简单理解：包含了线程 和 选择器 selector
                 *
                 *        BossEventLoop
                 *                    作用：处理可连接事件
                 *        WorkerEventLoop
                ...
                .childHandler(
                         ...
                         *
                         * ChannelInitializer 触发处理器(SocketChannel连接后 将被调用一次)，负责添加别的 handler;
                         */
